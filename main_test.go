...
build python --build-arg VERSION=3.6 --build-arg OS=alpine -t localhost:5000/latest -t localhost:5000/images/python:3.6-alpine -t localhost:5000/images/python:3.6-alpine-7
